...
- TWAS-based Predicted Polygenic Polygenic Transcriptional Risk Score (PPTRS) based on predicted gene expression. 
- Transcriptional Risk Score from measured gene expression (TRS). 
